  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <form action={register} className="space-y-5 rounded-3xl border border-blue-100/80 bg-white/85 p-8 shadow-[0_24px_70px_rgba(37,99,235,0.12)] backdrop-blur">
          <div>
            <label className="block text-sm font-semibold text-slate-700">สมัครในฐานะ</label>
            <div className="mt-2 grid grid-cols-2 gap-3">
              <label className="cursor-pointer rounded-xl border border-blue-200 bg-white/70 p-3 text-center transition-colors has-[:checked]:border-blue-500 has-[:checked]:bg-blue-50">
