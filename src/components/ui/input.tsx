  ...
  return (
    <div className="w-full">
      ...
      <input
        id={inputId}
        className={cn(
          'min-h-[44px] w-full rounded-xl border border-blue-100 bg-white/90 px-4 py-2.5 text-base text-slate-900 shadow-sm transition-colors sm:text-sm',
  ...
  return (
    <div className="w-full">
      ...
      <textarea
        id={textareaId}
        className={cn(
          'min-h-[96px] w-full rounded-xl border border-blue-100 bg-white/90 px-4 py-2.5 text-base text-slate-900 shadow-sm transition-colors sm:text-sm',
          'placeholder:text-slate-400',
          'focus:border-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-100',
          'disabled:bg-slate-50 disabled:text-slate-500',
          error && 'border-rose-400 focus:border-rose-400 focus:ring-rose-100',
